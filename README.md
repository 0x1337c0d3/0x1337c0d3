...
───────────────────────────────────────────────────────────────────────────────
┌──────────┐                                    ┌─────────────┬───────────────┐
│ EMBEDDED ├──┐                   research ───→ │ CNAPP / AWS │ Threat Model  │
└──────────┘  │                                 │ SAST / SCA  │ Risk Advisory │
┌──────────┐  │  ░░░░░░░░░░                     │ Bug Bounty  │ Pen Testing   │
│ GAME DEV ├──┼─ SECURITY ────────────────────→ │ OWASP       │ DevSecOps     │
└──────────┘  │  ░░░░░░░░░░                     └─────────────┴───────────────┘
┌──────────┐  │
...
かいしゃ
───────────────────────────────────────────────────────┬───────────────────────
2024/01 → Principal Engineer, App & Product Security   │      originenergy.com.au
             Origin Energy                             ┤
2019/06 → Application Security Engineer                │
2018/05 → Senior Software Engineer                     │
             Latitude Financial Services               ┤
2017/01 → Lead Engineer — iOS                          │
2015/05 → Senior iOS Developer                         │
             ANZ                                       ┤
2010/06 → Founder                                      │       onereddog.com.au
             One Red Dog Media                         ┤
2009/01 → Co-Founder / CTO                             │
             Fun Guy Media                             ┤
2006/11 → Software Engineer — Mac Device Drivers       │
             Bluefish444                               ┤
2005/06 → Senior Programmer                            │
             Tantalus Interactive                      ┤
2001/09 → Project Team Leader                          │
             NEC Australia                             ┤
2000/10 → Senior Programmer                            │
             BAM! Studios London                       ┤
2000/04 → Lead Programmer                              │
             Acclaim Entertainment                     ┤
1995/07 → Game Programmer → Lead Programmer            │
